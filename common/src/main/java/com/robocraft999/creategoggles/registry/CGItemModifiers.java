...
public class CGItemModifiers {
    ...
    public static final RegistryEntry<ItemModifier, ? extends ItemModifier>
    ...
    private static RegistryEntry<ItemModifier, ? extends ItemModifier> modifier(String name, Predicate<ItemStack> predicate, TagKey<Item> incompatibleItems) {
        return REGISTRATE.object(name).simple(name, ITEM_MODIFIER_REGISTRY, () -> new ItemModifier(name, predicate, incompatibleItems));
    }

    private static RegistryEntry<ItemModifier, ? extends ItemModifier> modifierRemover(String name, Predicate<ItemStack> predicate, TagKey<Item> incompatibleItems) {
